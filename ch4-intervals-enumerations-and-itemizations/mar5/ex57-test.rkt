...
(define GROUNDED (- HEIGHT CENTER)) ;; starting distance between ROCKET and ground
...
(check-expect (render-world 14) (render-rocket (- GROUNDED 14)))
...
(define (render-rocket dist-from-ground)
  (place-image ROCKET 10 dist-from-ground BACKG))
