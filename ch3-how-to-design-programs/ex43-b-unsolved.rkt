...
;; Basic wave formula
;; func(t) = A * sin * (2 * pi * f * t + phase)
;; where:
;;      - f is the frequency, which controls the number of times the waves repeats per
;;      unit time, f = 1/P where P is the number of periods.
;;      - A is the amplitude of the wave, which represents the highest and lowest points
;;      of the wave.
