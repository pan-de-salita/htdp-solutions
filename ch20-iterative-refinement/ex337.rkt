...
;; Dir.v3 -> Number
;; like how-many.v3, returns the number of files in a dir.v3
(define (how-many.v3-simplified dir.v3)
  (foldr + (length (dir.v3-files dir.v3)) (map how-many.v3-simplified (dir.v3-dirs dir.v3)))
  ;; previous solution:
  ;; (+ (length (dir.v3-files dir.v3))
  ;;    (foldr + 0 (map how-many.v3-simplified (dir.v3-dirs dir.v3))))
  )

(check-expect (how-many.v3-simplified Code.v3) (how-many.v3 Code.v3))
(check-expect (how-many.v3-simplified Docs.v3) (how-many.v3 Docs.v3))
(check-expect (how-many.v3-simplified Text.v3) (how-many.v3 Text.v3))
(check-expect (how-many.v3-simplified Libs.v3) (how-many.v3 Libs.v3))
(check-expect (how-many.v3-simplified TS.v3) (how-many.v3 TS.v3))

;; Dir.v3 -> Number
;; like how-many.v3, returns the number of files in a dir.v3
(define (how-many.v3-for-sum dir.v3)
  (+ (for/sum ([dir (dir.v3-dirs dir.v3)])
       (how-many.v3-for-sum dir))
     (length (dir.v3-files dir.v3))))

(check-expect (how-many.v3-for-sum Code.v3) (how-many.v3 Code.v3))
(check-expect (how-many.v3-for-sum Docs.v3) (how-many.v3 Docs.v3))
(check-expect (how-many.v3-for-sum Text.v3) (how-many.v3 Text.v3))
(check-expect (how-many.v3-for-sum Libs.v3) (how-many.v3 Libs.v3))
(check-expect (how-many.v3-for-sum TS.v3) (how-many.v3 TS.v3))
