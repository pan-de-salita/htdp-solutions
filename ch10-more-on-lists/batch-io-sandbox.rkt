...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname batch-io-sandbox) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(check-expect (wc-short "ttt.txt") (make-info 13 33 184))
...
;; String -> Info
;; Counts the number of lines, words, and characters in the given file.
(check-expect (wc-recursive "ttt.txt") (make-info 13 33 184))
...
(check-expect (count-all lls3) (make-info 2 0 2))
...
(check-expect (count-chars lls0) 2)
