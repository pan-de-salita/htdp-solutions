...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex108-ye) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define STOP-IMAGE (bitmap "./pedestrian_traffic_light_red.png"))
(define WALK-IMAGE (bitmap "./pedestrian_traffic_light_green.png"))
