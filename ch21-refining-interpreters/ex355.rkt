...
(check-error (eval-variable* bsl-var-expr0 al0) UNDEFINED-VARIABLE/S)
(check-error (eval-variable* bsl-var-expr1 al0) UNDEFINED-VARIABLE/S)
(check-error (eval-variable* bsl-var-expr2 al0) UNDEFINED-VARIABLE/S)
(check-error (eval-variable* bsl-var-expr3 al0) UNDEFINED-VARIABLE/S)

(check-expect (eval-variable* bsl-var-expr0 al1) 5)
(check-expect (eval-variable* bsl-var-expr1 al1) 8)
(check-within (eval-variable* bsl-var-expr2 al1) 7.5 0.001)
(check-error (eval-variable* bsl-var-expr3 al1) UNDEFINED-VARIABLE/S)
...
(check-error (eval-variable*.v2 bsl-var-expr0 al0) UNDEFINED-VARIABLE/S)
(check-error (eval-variable*.v2 bsl-var-expr1 al0) UNDEFINED-VARIABLE/S)
(check-error (eval-variable*.v2 bsl-var-expr2 al0) UNDEFINED-VARIABLE/S)
(check-error (eval-variable*.v2 bsl-var-expr3 al0) UNDEFINED-VARIABLE/S)

(check-expect (eval-variable*.v2 bsl-var-expr0 al1) 5)
(check-expect (eval-variable*.v2 bsl-var-expr1 al1) 8)
(check-within (eval-variable*.v2 bsl-var-expr2 al1) 7.5 0.001)
(check-error (eval-variable*.v2 bsl-var-expr3 al1) UNDEFINED-VARIABLE/S)
...
;; BSL-var-expr AL -> BSL-eval
;; returns the value of a-bsl-var-expr,
;; but instead of using subst, uses assq
(define (eval-var-lookup a-bsl-var-expr def-area)
  (match a-bsl-var-expr
    [(? number?) a-bsl-var-expr]
    [(? symbol?)
     (local ((define found-association
               (assq a-bsl-var-expr def-area)))
       (if (false? found-association)
           (error UNDEFINED-VARIABLE/S)
           (cadr found-association)))]
    [(add left right)
     (+ (eval-var-lookup left def-area)
        (eval-var-lookup right def-area))]
    [(mul left right)
     (* (eval-var-lookup left def-area)
        (eval-var-lookup right def-area))]))

(check-error (eval-var-lookup bsl-var-expr0 al0) UNDEFINED-VARIABLE/S)
(check-error (eval-var-lookup bsl-var-expr1 al0) UNDEFINED-VARIABLE/S)
(check-error (eval-var-lookup bsl-var-expr2 al0) UNDEFINED-VARIABLE/S)
(check-error (eval-var-lookup bsl-var-expr3 al0) UNDEFINED-VARIABLE/S)

(check-expect (eval-var-lookup bsl-var-expr0 al1) 5)
(check-expect (eval-var-lookup bsl-var-expr1 al1) 8)
(check-within (eval-var-lookup bsl-var-expr2 al1) 7.5 0.001)
(check-error (eval-var-lookup bsl-var-expr3 al1) UNDEFINED-VARIABLE/S)

(check-expect (eval-var-lookup bsl-var-expr0 al2) 5)
(check-expect (eval-var-lookup bsl-var-expr1 al2) 8)
(check-within (eval-var-lookup bsl-var-expr2 al2) 7.5 0.001)
(check-expect (eval-var-lookup bsl-var-expr3 al2) 34)
