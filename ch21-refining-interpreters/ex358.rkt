...
(define da-fgh `(,fun-def-f ,fun-def-g ,fun-def-h))
...
(check-expect (lookup-def da-fgh 'f) fun-def-f)
(check-expect (lookup-def da-fgh 'g) fun-def-g)
(check-expect (lookup-def da-fgh 'h) fun-def-h)
